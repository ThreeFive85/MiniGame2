...
# 공 크기에 따른 최초 스피드
ball_speed_y = [-21, -18, -15, -12]  # index 0, 1, 2, 3 에 해당하는 값
...
balls.append({
    ...
    "to_y": -6,  # y축 이동방향, 공이 무기에 맞으면 살짝 올라가는 효과
...
# 게임 종료 메시지 / TimeOut, Mission Complete. Game Over(캐릭터가 공에 맞음)
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_LEFT:  # 캐릭터를 왼쪽으로
                ...
                weapon_x_pos = character_x_pos + \
                    (character_width / 2) - (weapon_width / 2)  # 무기 위치 지정
